...
class InitialStateSerializer < ActiveModel::Serializer
  ...
  def meta
    ...
    store[:c3_official_site_url] = ENV.fetch('C3_OFFICIAL_SITE_URL') if ENV['C3_OFFICIAL_SITE_URL'].present?

    store[:c3_toybox_url] = ENV.fetch('C3_TOYBOX_URL') if ENV['C3_TOYBOX_URL'].present?
