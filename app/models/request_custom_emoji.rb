...
class RequestCustomEmoji < ApplicationRecord
  ...
  # TODO: shortcodeカラムの一意性を保証するか捨てるか決める(マイグレーションでインデックス追加？)
  validates :shortcode, uniqueness: true, format: { with: CustomEmoji::SHORTCODE_ONLY_RE }, length: { minimum: CustomEmoji::MINIMUM_SHORTCODE_SIZE } # rubocop:disable Rails/UniqueValidationWithoutIndex
